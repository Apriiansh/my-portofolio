      ...
      <div className="text-center z-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="/my-cv.pdf"
            download="my-cv.pdf"
            className="px-8 sm:px-12 md:px-16 py-4 bg-gradient-to-r from-[var(--accent)] to-[var(--accent-secondary)] text-white font-semibold rounded-full hover:opacity-90 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
            My CV
          </a>
